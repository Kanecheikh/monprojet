...
/*import javaprojetgesecole.connexion.connection;*/
	...
	/*connection maconnexion = new connection();*/
	    ...
	    public listusers() {
	       ...
	       /* model.addColumn("Date_Nai");
	        ...
	        String requeteListe="select * from users";
	        /*try{
	            stListe=maconnexion.etablirconnection().createStatement();
	            ResultSet resultat =stListe.executeQuery(requeteListe);
	            while(resultat.next()){
	                model.addRow(new Object []{ resultat.getString("login"),resultat.getString("password")});
	            }
